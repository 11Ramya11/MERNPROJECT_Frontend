...
import './Servicesac.css'; // Import a custom CSS file for additional styling
...
const Servicesac = () => {
  const [items, setItems] = useState([
    ...
    {
      id: 3,
      image: '/assets/Clothing33.jpg',
      reviews: [
        { id: 5, rating: 4, comment: 'Good fit.' },
        { id: 6, rating: 3, comment: 'Satisfied.' },
      ],
    },
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-12">
            ...
            <h1 className="display-6 text-center mb-4 text-warning">Levi's Clothing Reviews</h1>
