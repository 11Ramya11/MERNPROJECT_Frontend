...
import './Servicesfc.css'; // Import a custom CSS file for additional styling
...
const Servicesfc = () => {
  const [items, setItems] = useState([
    {
      id: 1,
      image: '/assets/Homeapp31.jpg',
      reviews: [
        { id: 1, rating: 5, comment: 'Great product! Excellent quality.' },
        { id: 2, rating: 4, comment: 'Smooth Blending' },
      ],
    },
    {
      id: 2,
      image: '/assets/Homeapp32.jpg',
      reviews: [
        { id: 3, rating: 3, comment: 'Kitchen Essential' },
        { id: 4, rating: 5, comment: 'Powerful Performance' },
      ],
    },
    {
      id: 3,
      image: '/assets/Homeapp33.jpg',
      reviews: [
        { id: 5, rating: 4, comment: 'Durable design' },
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-12">
            ...
            <h1 className="display-6 text-center mb-4 text-warning">Philips Mixer Reviews</h1>
