...
import './Servicesda.css'; // Import a custom CSS file for additional styling
...
const Servicesda = () => {
  const [items, setItems] = useState([
    {
      id: 1,
      image: '/assets/Mobiles11.jpg',
      reviews: [
        { id: 1, rating: 5, comment: 'Fast and Smooth' },
        { id: 2, rating: 4, comment: 'Camera Brilliance' },
      ],
    },
    {
      id: 2,
      image: '/assets/Mobiles12.jpg',
      reviews: [
        { id: 3, rating: 3, comment: 'Decent product. Could be improved.' },
        { id: 4, rating: 5, comment: 'Love the style' },
      ],
    },
    {
      id: 3,
      image: '/assets/Mobiles13.jpg',
      reviews: [
        { id: 5, rating: 4, comment: 'Impressive Features' },
        { id: 6, rating: 2, comment: 'Fast snd smooth' },
      ],
    },
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-12">
            ...
            <h1 className="display-6 text-center mb-4 text-warning">Mahindra Cars Reviews</h1>
