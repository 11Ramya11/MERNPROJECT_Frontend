...
import './Servicesba.css'; // Import a custom CSS file for additional styling
...
const Servicesba = () => {
  const [items, setItems] = useState([
    {
      id: 1,
      image: '/assets/Footwear11.jpg',
      reviews: [
        { id: 1, rating: 5, comment: 'Comfy Elegance!' },
        { id: 2, rating: 4, comment: 'Happy Feet!' },
      ],
    },
    {
      id: 2,
      image: '/assets/Footwear12.jpg',
      reviews: [
    ...
    {
      id: 3,
      image: '/assets/Footwear13.jpg',
      reviews: [
        { id: 5, rating: 4, comment: 'Stylish Comfort' },
        { id: 6, rating: 3, comment: 'Fashionable Support' },
      ],
    },
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-12">
            ...
            <h1 className="display-6 text-center mb-4 text-warning">Nike Footwear Reviews</h1>
