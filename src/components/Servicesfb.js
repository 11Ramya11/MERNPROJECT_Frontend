...
import './Servicesfb.css'; // Import a custom CSS file for additional styling
...
const Servicesfb = () => {
  const [items, setItems] = useState([
    {
      id: 1,
      image: '/assets/Homeapp21.jpg',
      reviews: [
        { id: 1, rating: 5, comment: 'Great product! Excellent quality.' },
        { id: 2, rating: 4, comment: 'Efficient Cleaning.' },
      ],
    },
    {
      id: 2,
      image: '/assets/Homeapp22.jpg',
      reviews: [
        { id: 3, rating: 3, comment: 'Time Saver.' },
        { id: 4, rating: 5, comment: 'Quiet powerhouse!'},
      ],
    },
    {
      id: 3,
      image: '/assets/Homeapp23.jpg',
      reviews: [
        { id: 5, rating: 4, comment: 'Spotless Laundry.' },
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-12">
            ...
            <h1 className="display-6 text-center mb-4 text-warning">IFB Washing Machine Reviews</h1>
