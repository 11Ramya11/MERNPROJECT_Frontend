...
import './Servicescb.css'; // Import a custom CSS file for additional styling
...
const Servicescb = () => {
  const [items, setItems] = useState([
    {
      id: 1,
      image: '/assets/Skincare21.jpg',
      reviews: [
        { id: 1, rating: 5, comment: 'Miracle Serum' },
        { id: 2, rating: 4, comment: 'Glowing Skin!' },
      ],
    },
    {
      id: 2,
      image: '/assets/Skincare22.jpg',
      reviews: [
        { id: 3, rating: 3, comment: 'Decent product. Could be improved.' },
        { id: 4, rating: 5, comment: 'Youthful Glow.' },
      ],
    },
    {
      id: 3,
      image: '/assets/Skincare23.jpg',
      reviews: [
        { id: 5, rating: 4, comment: 'Clear complexion' },
        { id: 6, rating: 2, comment: 'Skin Savior!' },
      ],
    },
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-12">
            ...
            <h1 className="display-6 text-center mb-4 text-warning">Lakme Skin care Reviews</h1>
