...
import './Servicesea.css'; // Import a custom CSS file for additional styling
...
const Servicesea = () => {
  const [items, setItems] = useState([
    {
      id: 1,
      image: '/assets/Cars11.jpg',
      reviews: [
        { id: 1, rating: 5, comment: 'Smooth Ride' },
        { id: 2, rating: 4, comment: 'Performance Beast' },
      ],
    },
    {
      id: 2,
      image: '/assets/Cars12.jpg',
      reviews: [
        { id: 3, rating: 3, comment: 'Decent look. Could be improved.' },
        { id: 4, rating: 5, comment: 'Elegant drive' },
      ],
    },
    {
      id: 3,
      image: '/assets/Cars13.jpg',
      reviews: [
        { id: 5, rating: 4, comment: 'Fuel efficiency' },
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-12">
            ...
            <h1 className="display-6 text-center mb-4 text-warning">Samsung Mobile Reviews Reviews</h1>
