...
import './Servicesfa.css'; // Import a custom CSS file for additional styling
...
const Servicesfa = () => {
  const [items, setItems] = useState([
    {
      id: 1,
      image: '/assets/Homeapp11.jpg',
      reviews: [
        { id: 1, rating: 5, comment: 'Great product!' },
        { id: 2, rating: 4, comment: 'Smart Tech' },
      ],
    },
    {
      id: 2,
      image: '/assets/Homeapp12.jpg',
      reviews: [
        { id: 3, rating: 3, comment: 'Decent product. Could be improved.' },
        { id: 4, rating: 5, comment: 'Picture perfect' },
      ],
    },
    {
      id: 3,
      image: '/assets/Homeapp13.jpg',
      reviews: [
        { id: 5, rating: 4, comment: 'Immersive Viewing' },
        { id: 6, rating: 2, comment: 'Product could be improved' },
      ],
    },
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-12">
            ...
            <h1 className="display-6 text-center mb-4 text-warning">Samsung Television Reviews</h1>
